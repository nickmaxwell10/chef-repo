...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "nickmaxwell10-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/nickmaxwell10"
  #   chef.validation_client_name = "nickmaxwell10-validator"
  #   chef.validation_key_path = ".chef/nickmaxwell10-validator.pem"
  # end
end
